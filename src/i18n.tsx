...
const translations = {
  pt: {
    ...
    howto: {
      ...
      step3: "Toque num músculo no mapa para ver os exercícios que o trabalham",
    },
    muscleSheet: {
      count: "%{n} exercícios",
      primary: "Primários",
      secondary: "Secundários",
      empty: "Sem exercícios para este músculo.",
    },
    bodyparts: {
      abs: "Abdominais",
      adductors: "Adutores",
  ...
  en: {
    ...
    howto: {
      ...
      step3: "Tap a muscle on the map to see the exercises that work it",
    },
    muscleSheet: {
      count: "%{n} exercises",
      primary: "Primary",
